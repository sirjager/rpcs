...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _TRUEAUTH.methods_by_name['Signup']._options = None
  _TRUEAUTH.methods_by_name['Signup']._serialized_options = b'\202\323\344\223\002\017\"\n/v1/signup:\001*\222A$\n\004Auth\022\rRegister user\032\rRegister user'
  _TRUEAUTH.methods_by_name['Signin']._options = None
  _TRUEAUTH.methods_by_name['Signin']._serialized_options = b'\202\323\344\223\002\017\"\n/v1/signin:\001*\222A\036\n\004Auth\022\nLogin user\032\nLogin user'
  _TRUEAUTH.methods_by_name['Signout']._options = None
  _TRUEAUTH.methods_by_name['Signout']._serialized_options = b'\202\323\344\223\002\020\"\013/v1/signout:\001*\222A&\n\004Auth\022\016Log\'s out user\032\016Log\'s out user'
  ...
  _TRUEAUTH.methods_by_name['Users']._options = None
  _TRUEAUTH.methods_by_name['Users']._serialized_options = b'\202\323\344\223\002\013\022\t/v1/users\222A&\n\004User\022\016List all users\032\016List all users'
  _TRUEAUTH.methods_by_name['User']._options = None
  _TRUEAUTH.methods_by_name['User']._serialized_options = b'\202\323\344\223\002\026\022\024/v1/users/{identity}\222A\032\n\004User\022\010Get user\032\010Get user'
  _TRUEAUTH._serialized_start=250
  _TRUEAUTH._serialized_end=1505
