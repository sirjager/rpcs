...
type ResetRequest struct {
	...
	// By default this will send password-reset-token to registered email
	// if user has already requested password-reset-token and has password-reset-token code then password will be reseted
...
var file_rpc_reset_proto_rawDesc = []byte{
	0x0a, 0x0f, 0x72, 0x70, 0x63, 0x2d, 0x72, 0x65, 0x73, 0x65, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x12, 0x08, 0x74, 0x72, 0x75, 0x65, 0x61, 0x75, 0x74, 0x68, 0x22, 0x5b, 0x0a, 0x0c, 0x52,
	0x65, 0x73, 0x65, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x63,
	...
	0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x22, 0x29, 0x0a, 0x0d, 0x52, 0x65, 0x73, 0x65,
...
var file_rpc_reset_proto_goTypes = []interface{}{
...
func file_rpc_reset_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_rpc_reset_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_rpc_reset_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
