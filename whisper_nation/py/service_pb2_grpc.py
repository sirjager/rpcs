...
import rpc_group_pb2 as rpc__group__pb2
...
class WhisperNationStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CreateGroup = channel.unary_unary(
                ...
                request_serializer=rpc__group__pb2.CreateGroupRequest.SerializeToString,
                response_deserializer=rpc__group__pb2.CreateGroupResponse.FromString,
                )
        self.ListGroups = channel.unary_unary(
                '/whisper_nation.WhisperNation/ListGroups',
                request_serializer=rpc__group__pb2.ListGroupsRequest.SerializeToString,
                response_deserializer=rpc__group__pb2.ListGroupsResponse.FromString,
                )
        self.ListGroupMembers = channel.unary_unary(
                '/whisper_nation.WhisperNation/ListGroupMembers',
                request_serializer=rpc__group__pb2.ListGroupMembersRequest.SerializeToString,
                response_deserializer=rpc__group__pb2.ListGroupMembersResponse.FromString,
                )
...
def add_WhisperNationServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'CreateGroup': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=rpc__group__pb2.CreateGroupRequest.FromString,
                    response_serializer=rpc__group__pb2.CreateGroupResponse.SerializeToString,
            ),
            'ListGroups': grpc.unary_unary_rpc_method_handler(
                    servicer.ListGroups,
                    request_deserializer=rpc__group__pb2.ListGroupsRequest.FromString,
                    response_serializer=rpc__group__pb2.ListGroupsResponse.SerializeToString,
            ),
            'ListGroupMembers': grpc.unary_unary_rpc_method_handler(
                    servicer.ListGroupMembers,
                    request_deserializer=rpc__group__pb2.ListGroupMembersRequest.FromString,
                    response_serializer=rpc__group__pb2.ListGroupMembersResponse.SerializeToString,
            ),
    }
...
class WhisperNation(object):
    ...
    def CreateGroup(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/whisper_nation.WhisperNation/CreateGroup',
            rpc__group__pb2.CreateGroupRequest.SerializeToString,
            rpc__group__pb2.CreateGroupResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def ListGroups(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/whisper_nation.WhisperNation/ListGroups',
            rpc__group__pb2.ListGroupsRequest.SerializeToString,
            rpc__group__pb2.ListGroupsResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def ListGroupMembers(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/whisper_nation.WhisperNation/ListGroupMembers',
            rpc__group__pb2.ListGroupMembersRequest.SerializeToString,
            rpc__group__pb2.ListGroupMembersResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
